...
const MainContainer = () => {
  ...
  return (
    ...
    <div className='p-2 space-x-5'>
        <button className='rounded-lg bg-gray-300 p-2'>All</button>
        <button className='rounded-lg bg-gray-300 p-2'>Gaming</button>
        ...
        <button className='rounded-lg bg-gray-300 p-2'>News</button>
        <button className='rounded-lg bg-gray-300 p-2'>All</button>
        <button className='rounded-lg bg-gray-300 p-2'>Gaming</button>
        <button className='rounded-lg bg-gray-300 p-2'>Music</button>
        <button className='rounded-lg bg-gray-300 p-2'>Movies</button>
